...
parser.add_argument("--akaze-threshold", type=float, default=0.001, help="Seuil de détection AKAZE")
# Filtrage de Lowe
parser.add_argument('--lowe', help='Lowe ratio', type=float, default=0.8)
# RANSAC
parser.add_argument('--ransac', help='RANSAC threshold', type=int, default=5)
...
if len(good_matchs) > 10:
    ...
    E, mask = cv.findEssentialMat(pts1, pts2, newcameramtx, method=cv.RANSAC, prob=0.999, threshold=1.0)
...
print('--- Résultats du Matching AKAZE ---')
