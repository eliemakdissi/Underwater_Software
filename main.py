...
def main():
    ...
    filtered_audio = apply_dual_band_filter(mono_audio, sample_rate, args.relative_margin, args.filter_order)
    ...
    print(f"Filtered bands: {TARGET_FREQS_HZ[0]} Hz and {TARGET_FREQS_HZ[1]} Hz")
